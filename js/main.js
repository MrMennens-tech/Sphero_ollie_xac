...
// AANGEPAST: Variabelen voor het "throttlen" van drive-commando's om mobiele performance te verbeteren.
let lastDriveCommandTime = 0;
const DRIVE_COMMAND_THROTTLE = 100; // ms, stuurt max 10x per seconde
...
                let speedCap = isExpertMode ? EXPERT_MAX_SPEED : NORMAL_MAX_SPEED;
                // AANGEPAST: Throttling voor het drive-commando
                const now = Date.now();
                if (now - lastDriveCommandTime > DRIVE_COMMAND_THROTTLE) {
